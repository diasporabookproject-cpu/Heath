...
### Session 8 — 2026-07-04 (Refonte UI « Bento lumineux » — Lot 0)
...
- **STOP fin Lot 0** — en attente des retours d'Amine avant le Lot 1 (Maison & navigation), où l'on s'arrêtera de nouveau juste avant l'écran Maison pour valider la mécanique Personne/contexte en vrai.
