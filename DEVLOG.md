...
- **Reste du Lot 2** : **passe cosmétique** de renommage `cz-/nz-/ck-` → `mz-` (sans changement visuel), et vérifier le **scoping des espaces reçus** (`#e=`) pour qu'ils ne soient pas emportés par le retheme `.cz` global.
