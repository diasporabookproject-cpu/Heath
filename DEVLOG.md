...
- **STOP fin Lot 1** — en attente des retours d'Amine. Prochain : Lot 2 (pages restylées `mz-` : en-têtes héros, barres d'action basses, mort de `cz-/nz-/ck-`). Test global à faire une fois déployé.
