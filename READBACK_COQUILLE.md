> **📦 ARCHIVE (contexte : `coquille-v1`, 2026-07-07).** Read-back de la PREMIÈRE coquille,
> recréée depuis en `coquille-v2` (cf. DEVLOG 2026-07-11 et `READBACK_COQUILLE_V2.md`).
> Les décisions et la liste des « 8 pièges » restent la référence ; le plan d'implémentation
> décrit ici est remplacé par celui de la v2 (dist-native séparé, loadEnv).
