...
--
-- ✅ APPLIQUÉE en PROD le 2026-07-05 (passe de déploiement Comptes+Sync, via API Management)
-- et REJOUÉE sur le staging reconstruit (lot Environnements, 2026-07-08). Idempotente (drop+create).
